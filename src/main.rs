...
use dendrite::example_api::init;
use dendrite::example_command::handle_commands;
use dendrite::example_event::process_events;
use dendrite::example_query::process_queries;
use dendrite::grpc_example::greeter_service_server::GreeterServiceServer;

#[tokio::main]
async fn main() -> Result<(), Box<dyn Error>> {
    env_logger::init();
    info!("Dendrite API service started");
